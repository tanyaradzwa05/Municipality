<%@ Page Language="C#" AutoEventWireup="true" CodeFile="wastemanagement.aspx.cs" Inherits="wastemanagement" %>
        ...
        <div class="container">
			...
			<div class="table-responsive">
                <table id="policiesTable" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        <tr>
                        <td><a href="http://www.drrsmompatidm.gov.za/index.php/documents/doc_download/204-integrated-waste-management-plan"> 
                         <img src="images/pdf.png" alt="file icon">Whistle Blowing Policy</a></td>
                        <td><a  href="http://www.drrsmompatidm.gov.za/index.php/documents/doc_view/204-integrated-waste-management-plan?tmpl=component&format=raw target="_blank">View Online </a></td>
                        </tr>
                    </tbody>                    
               </table>
			</div>
